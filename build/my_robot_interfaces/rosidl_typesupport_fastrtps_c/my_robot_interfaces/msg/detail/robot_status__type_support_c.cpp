...
#include "my_robot_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = my_robot_interfaces__msg__RobotStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: are_motor_ready
  {
    cdr << (ros_message->are_motor_ready ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: are_motor_ready
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->are_motor_ready = tmp ? true : false;
  }
...
size_t get_serialized_size_my_robot_interfaces__msg__RobotStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name are_motor_ready
  {
    size_t item_size = sizeof(ros_message->are_motor_ready);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name debug_message
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__RobotStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__RobotStatus;
    is_plain =
      (
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__msg__RobotStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, RobotStatus)() {
