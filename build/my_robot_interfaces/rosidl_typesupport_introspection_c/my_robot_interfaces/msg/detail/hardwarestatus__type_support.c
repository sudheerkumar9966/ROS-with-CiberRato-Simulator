...
#include <stddef.h>
#include "my_robot_interfaces/msg/detail/hardwarestatus__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__Hardwarestatus__rosidl_typesupport_introspection_c__Hardwarestatus_message_member_array[3] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__msg__Hardwarestatus, are_motor_ready),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
