...
{
  new (message_memory) my_robot_interfaces::msg::Hardwarestatus(_init);
}

void Hardwarestatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_interfaces::msg::Hardwarestatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Hardwarestatus_message_member_array[3] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::Hardwarestatus, temperature),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::Hardwarestatus, are_motor_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Hardwarestatus_message_members = {
  ...
  3,  // number of fields
  sizeof(my_robot_interfaces::msg::Hardwarestatus),
...
{
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Hardwarestatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, msg, Hardwarestatus)() {
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Hardwarestatus_message_type_support_handle;
}
